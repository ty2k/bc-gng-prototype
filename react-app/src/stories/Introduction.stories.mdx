...
import Code from '../components/assets/code-brackets.svg';
import Colors from '../components/assets/colors.svg';
import Comments from '../components/assets/comments.svg';
import Direction from '../components/assets/direction.svg';
import Flow from '../components/assets/flow.svg';
import Plugin from '../components/assets/plugin.svg';
import Repo from '../components/assets/repo.svg';
import StackAlt from '../components/assets/stackalt.svg';
